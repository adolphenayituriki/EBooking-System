    ...
    <>
      <section className="page-hero">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <span className="text-gray-300 font-semibold text-sm uppercase tracking-widest">Venues</span>
              ...
              return (
                <div key={hall._id} className="card group flex flex-col" style={{ animationDelay: `${i * 0.05}s` }}>
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    <h3 className="font-display text-xl font-bold text-gray-900 mb-2">{hall.name}</h3>
                    <p className="text-gray-500 text-sm leading-relaxed mb-4 flex-1">{hall.description}</p>
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-gray-100 mt-auto">
                      <div>
                    <span className="text-2xl font-display font-bold text-gray-900">{formatPrice(hall.price)}</span>
                    <span className="text-gray-400 text-sm"> / event</span>
                      </div>
                      <button onClick={() => setSelected(hall)} className="btn-primary text-sm py-2.5 px-5">
                        Book Hall
                      </button>
                    </div>
                  </div>
